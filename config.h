...
static const Key keys[] = {
	...
	{ 0,       MODKEY,                                            Key_Left,                    shiftview,              {.i = -1} },
	{ 0,       MODKEY,                                            Key_Right,                   shiftview,              {.i = 1} },
	{ 0,       MODKEY|WLR_MODIFIER_CTRL,                          Key_Left,                    shiftviewvisible,       {.i = -1} },
	{ 0,       MODKEY|WLR_MODIFIER_CTRL,                          Key_Right,                   shiftviewvisible,       {.i = 1} },
...
#define CHVT(KEY,n) { 0, WLR_MODIFIER_CTRL|WLR_MODIFIER_ALT, KEY, chvt, {.ui = (n)} }
	...
	{ 1,       0,                                                 Key_XF86AudioLowerVolume,  spawn,                    {.v = (char *[]){"mcontrol", "pa_vol_add", "-0.05", "1.0", NULL}} },
	{ 1,       0,                                                 Key_XF86AudioRaiseVolume,  spawn,                    {.v = (char *[]){"mcontrol", "pa_vol_add", "+0.05", "1.0", NULL}} },
	{ 0,       0,                                                 Key_XF86AudioMute,         spawn,                    {.v = (char *[]){"mcontrol", "pa_vol_toggle", NULL}} },
	{ 1,       MODKEY,                                            Key_XF86AudioLowerVolume,  spawn,                    {.v = (char *[]){"mcontrol", "pa_mic_add", "-0.05", "1.0", NULL}} },
	{ 1,       MODKEY,                                            Key_XF86AudioRaiseVolume,  spawn,                    {.v = (char *[]){"mcontrol", "pa_mic_add", "+0.05", "1.0", NULL}} },
...
static const Gesture gestures[] = {
	{ SWIPE_3_LEFT,  shiftviewvisible, {.i = 1 } },
	{ SWIPE_3_RIGHT, shiftviewvisible, {.i = -1} },
	{ SWIPE_3_UP,    focusstack,       {.i = -1 } },
	{ SWIPE_3_DOWN,  focusstack,       {.i = 1} },
	{ SWIPE_4_LEFT,  shiftview,        {.i = 1 } },
	{ SWIPE_4_RIGHT, shiftview,        {.i = -1} },
	{ SWIPE_4_UP,    pushup,           {0} },
	{ SWIPE_4_DOWN,  pushdown,         {0} },
};
