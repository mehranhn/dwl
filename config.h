...
static const Rule rules[] = {
	...
	* when width or height == 0 the default size of the client is used*/
	...
	{ "discord",        "discord",                                  NULL,       1 << 5,       0,           0,         50,  50,  500, 500,   {NULL} },
	...
	{ "obs",            "obs",                                      NULL,       1 << 7,       0,           0,         50,  50,  500, 500,   {"obs", NULL} },
	{ "qbittorrent",    "qBittorrent",                              NULL,       1 << 8,       0,           0,         50,  50,  500, 500,   {"qbittorrent", NULL} },
...
static const Key keys[] = {
	...
	{ MODKEY,                                            Key_grave,                   spawn,                  {.v = (char *[]){"somebar", "-c", "toggle", "all", NULL}} },
	{ MODKEY|WLR_MODIFIER_SHIFT,                         Key_grave,                   spawn,                  {.v = (char *[]){"somebar", "-c", "toggle", "selected", NULL}} },
	TAGKEYS(                                             Key_1,                       0),
	TAGKEYS(                                             Key_2,                       1),
	TAGKEYS(                                             Key_3,                       2),
	TAGKEYS(                                             Key_4,                       3),
